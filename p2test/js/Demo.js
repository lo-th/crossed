...
function Demo(world){
  ...
  // this.w = window.innerWidth;//$(window).width();
  //  this.h = window.innerHeight;//$(window).height();
...
Demo.prototype.resize = function(w, h){
    that.resize(w, h);
}
...
Demo.prototype.createLinks = function(){
    var linkDiv = document.createElement("div");
    linkDiv.setAttribute("id","link");
    document.body.appendChild(linkDiv);
    var l = [];
    var links = ['circles', 'collisions', 'compound', 'constraints', 'friction', 'islandSolver', 'springs'];
    for(var i =0; i<links.length; i++){
        var l =  document.createElement("div");
        l .setAttribute("id","l");
        linkDiv.appendChild(l);
        l.innerHTML ="<a href='"+links[i]+".html'>"+links[i]+"<a>";
    }
