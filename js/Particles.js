...
function Emitter(domContainer, highContrast){
	...
	this.makeParticle = function(){
		...
		if(spareParticles.length>0){
			...
			particle = new Particle(highContrast); 
...
function Particle(highContrast){
	
	var domElement = this.domElement = document.createElement('div');

	if(highContrast)this.domElement.innerHTML = '<img src="img/orangeParticle.png" />';
	else this.domElement.style.background = 'url(img/orangeParticle.png) transparent'; 
